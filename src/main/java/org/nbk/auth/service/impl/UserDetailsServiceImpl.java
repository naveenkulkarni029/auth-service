package org.nbk.auth.service.impl;

import java.util.Arrays;
import java.util.List;

import org.nbk.auth.service.model.AppUser;
...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	final List<AppUser> users = Arrays.asList(new AppUser(1, "Naveen", encoder.encode("12345"), "USER"),
