package org.nbk.auth.service.security;

import javax.servlet.http.HttpServletResponse;

import org.nbk.auth.service.model.JwtConfig;
...
public class SecurityCredentialsConfig extends WebSecurityConfigurerAdapter {
	...
	// 1. make sure we use stateless session; session won't be used to store user's
	// state.
	// 2. handle an authorized attempts
	...
	// 4. allow all POST requests

	// 5. any other requests must be authenticated
